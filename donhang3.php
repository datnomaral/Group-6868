...
<h2  style="text-align: center; font-size: 30px; color: rgba(255, 140, 0, 1);">Chi tiết đơn hàng</h2>
    <div class="tren">
        <table>
            ...
            <td> 
                Đơn hàng: MD4_57524242825
                <br> 
                 Họ và tên: Trương Lê Gia Hưng
                 <br>
                Số điện thoại:0368686868
                <br>
                Địa chỉ: 78/7 Cầu giấy 
                <button style="background-color: green; border-radius: 10px; margin-right: 30%; " >Đang xử lí</button>
            </td>
        </table>
    </div>
    <div class="traitren">
    ...
    <div class="giua">
        <table>
           ...
           <td>
            ...
            <div class="cc">
                <a href="">Mochi Lưỡi Hổ</a>
                
                <p><span>270.000 đ</span></p>
            </div>
           </td>
    ...
    <div class="traiduoi">
        <button> <a href="đơn_hàng_của_khách.html">Quay Lại</a></button>
    </div>
    <!-- <div class="duoi"></div> -->

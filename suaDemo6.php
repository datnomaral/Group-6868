 ...
 <div class="khung">
    ...
    <table>
        <tr>
            ...
            <td>
                <span class="custom-span">
                    <input style="width: 100%;" type="text" id="text" name="text" value="Mochi Trầu Bà Kim Cương">
                </span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <span class="custom-span">
                    <input style="width: 100%;" type="text" id="text" name="text"value=" 310.000 đ ">
                </span>
            </td>
        </tr>

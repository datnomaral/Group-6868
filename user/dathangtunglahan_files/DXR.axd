...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_175-zA_0m');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_177-zA_0m');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_176-zA_0m');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_178-zA_0m');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
    background: url('/DXR.axd?r=0_2340-BA_0m');
}
.dxeTBVSys .dxeTBTrack_MetropolisBlue
{
    background: url('/DXR.axd?r=0_2341-BA_0m');
}
.dxeTBHSys .dxeTBTrack_MetropolisBlue
{
    height: 10px;
...
{
    background-image: url('/DXR.axd?r=0_2336-BA_0m');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2334-BA_0m');
}
.dxeTBVSys .dxeTBItem_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2337-BA_0m');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2335-BA_0m');
}
...
{
    background-image: url('/DXR.axd?r=0_2338-BA_0m');
}
.dxeTBVSys .dxeTBSmallTick_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2339-BA_0m');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2332-BA_0m');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick_MetropolisBlue
{
    background-image: url('/DXR.axd?r=0_2333-BA_0m');
}
...
.dxChrome .dxeCalendarFastNavItem_MetropolisBlue
{
    outline-style: auto;
}

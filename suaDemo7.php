 ...
 <div class="khung">
    ...
    <table>
        <tr>
            ...
            <td>
                <span class="custom-span">
                    <input style="width: 100%;" type="text" id="text" name="text" value="Mochi Xương Rồng">
                </span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <span class="custom-span">
                    <input style="width: 100%;" type="text" id="text" name="text"value=" 270.000 đ ">
                </span>
            </td>
        </tr>
